...
public class ExperimentsWriter {

    private String outputFile;
    private long maxTime;
    private IntervalCalculator intervalCalculator;

    ExperimentsWriter(String outputFile, long maxTime, IntervalCalculator intervalCalculator) {
    ...
    public static class Builder {
        ...
        public ExperimentsWriter build() {
            return new ExperimentsWriter(outputFile, maxTime, intervalCalculator);
        }
    }
}
