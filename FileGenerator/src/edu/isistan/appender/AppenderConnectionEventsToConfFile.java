...
public class AppenderConnectionEventsToConfFile {
    private enum FLAGS {
        ...
        FOLDER_OF_CONNECTION_EVENTS("-f", 1, true, new ArgumentHandler() {
            @Override
            public void handleArguments(String... args) {
                folderOfConnectionEvents = args[0];
            }
        });
    ...
    private static String folderOfConnectionEvents;

    public static void main(String[] args) {
        parseArguments(args);
        AppenderForConnectionEventsToConfFileWriter writer = new AppenderForConnectionEventsToConfFileWriter.Builder()
                .setFolderOfConnectionEvents(folderOfConnectionEvents)
