...
public class DeviceLoader extends Thread {
    ...
    private Class<ConnectionScoreCalculator> connectionScoreCalculatorClass=null;
    ...
    public DeviceLoader(String nodeName, long flops, int maxActiveJobs,
                        boolean networkEnergyManagementEnable, long batteryCapacityInJoules, int retryInterval, int amountOfRetries, Class<ConnectionScoreCalculator> connectionScoreCalculatorClass, String[] connectionScoreCalculatorArgs) {
        this.nodeName = nodeName;
        this.flops = flops;
        this.maxActiveJobs = maxActiveJobs;
        this.networkEnergyManagerEnable = networkEnergyManagementEnable;
    ...
    public void run() {
        ...
        connectionManager = MANAGER_FACTORY.createConnectionManager(connectionScoreCalculatorClass, connectionScoreCalculatorArgs);
        Device device;
        if (retryInterval != 0) {
